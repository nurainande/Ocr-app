...
//   const [expectedVerbage, setExpectedVerbage] = useState("");
...
//     formData.append("expected_verbage", expectedVerbage);
//     formData.append("reference_image", imageFile); // actual file upload
//     ingredients.forEach((ing, i) => formData.append(`expected_ingredients[${i}]`, ing));
...
//       // Reset form
//       setName(""); setBarcode(""); setExpectedVerbage(""); setIngredients([""]); setImageFile(null);
//     } catch (err) {
//       console.error(err);
...
//           value={expectedVerbage}
//           onChange={(e) => setExpectedVerbage(e.target.value)}
//           className="w-full border p-2 rounded"
//           required
//         />
